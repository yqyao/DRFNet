...
from layers import *
import os
from models.drfssd.resnet_drfssd import DenseSSDResnet50
...
class SSD(nn.Module):
    ...
    def __init__(self, cfg, phase, num_classes, size):
        ...
        # SSD network
        self.extractor = DenseSSDResnet50(size)
...
def build_ssd(cfg, phase, size=300, num_classes=21, dense_size="48", use_extra_prior=True):
